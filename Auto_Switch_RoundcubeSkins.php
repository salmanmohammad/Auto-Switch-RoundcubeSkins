 ...
 *
 */
class Auto_Switch_RoundcubeSkins extends rcube_plugin {
  /**
   *
   * @var string
   */
...
//echo $_GET['test'];
    ...
    $this->add_button(array('task' => 'switch_skin','command' => 'switch_mobile','class' => 'about-link','classsel' => 'about-link button-selected','innerclass' => 'button-inner','label' => 'Auto_Switch_RoundcubeSkins.mobile'), 'topline-left');
  ...
  $skin = $this->rc->config->get('skin');
    ...
    if ($this->isMobile()) {
      if (in_array($this->rc->task, $this->rc->config->get("mobile_tasks", array('mail', 'addressbook', 'settings')))) {
        ...
        $this->include_stylesheet('../../skins/'.$skin.'_mobile/styles.min.css');
        // Config hook
  ...
  public function isMobile() {
    ...
    $mobile_skin = $this->rc->config->get('skin') == $skin."_mobile";
